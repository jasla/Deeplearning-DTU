...
\section{Results}
\label{sec:results}
This section contains the main results of the deep learning model described in the setup section ~\ref{sec:setup}.
As described before, the model is a classification model with three classes. One of the classes is used for collecting the background signal. The first indication that the model functions correctly is the component indentification. As it can be visualized in figure ~\ref{fig:components} the components look very similar to the one described in the setup section ~\ref{sec:setup}.
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.4\textwidth]{figures_3/DNN_D_vs_prob_6.png}
	\caption{Component identification}
\end{figure}
...
The difference between these results is described into depth in the discussion section. ~\ref{sec:discussion}
