...
The model parameters for the deep network is given in Table \ref{tab:parameters}. The sparsity parameter of the first layer is changed from 0.5 in the pre-training to 0.25 in the fine tuning phase of the deep network. This is done to ensure a background component in the autoencoder.
\vspace*{-0.2 cm}
\section{Results}
\label{sec:results}
